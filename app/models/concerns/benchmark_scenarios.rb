module BenchmarkScenarios
  SCENARIOS = [
    {
      id: "sepsis-1",
      name: "Sepsis with Elevated Lactate",
      description: "Rapid assessment of critical sepsis presentation with biomarker findings",
      context: <<~CTX.freeze,
        72-year-old male admitted to ICU with fever (39.2°C), hypotension (MAP 58), tachycardia (118 bpm), and altered mental status.
    ...
    },
    {
      ...
      description: "Multi-factorial respiratory failure requiring ventilator optimization",
      context: <<~CTX.freeze,
        54-year-old female, day 5 post-Op abdominal surgery (small bowel resection), now with progressive dyspnea and PaO2/FiO2 ratio declining.
    ...
    },
    {
      ...
      description: "Complex AKI management with multiple competing priorities",
      context: <<~CTX.freeze,
        66-year-old male, day 3 of sepsis recovery, now AKI Stage 3.
    ...
    },
    {
      ...
      description: "Hemodynamic optimization with limited cardiac reserve",
      context: <<~CTX.freeze,
        61-year-old male, STEMI 18 hours post-primary PCI with stent to LAD.
    ...
    },
    {
      ...
      description: "Multifactorial delirium requiring systematic workup and management",
      context: <<~CTX.freeze,
        78-year-old female, post-op day 2 (hip replacement).
        ...
        Medications: oxycodone PRN (has gotten it 4x since surgery), diphenhydramine PRN x 2 doses, propofol sedation 50 mcg/kg/min just weaned.
        Vitals: T 38.1C, HR 102, RR 22, SpO2 91% on 2L NC. Labs: sodium 128 (low), BUN 32, Cr 1.4 (baseline 0.9).
